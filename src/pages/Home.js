...
const addBookmark = (game) => {
    ...
    return (
        ...
        <form className="my-2 sm:w-full md:w-2/3 mx-auto flex px-2 text-2x1" onSubmit={handleSearch} >
        ...
        <div className="text-center underline text-xl">
        <Link className="mg-5" to={'/bookmarks'}>Favoris</Link>
        <Link className="mg-5" to={'/shop'}>Magasin</Link>
